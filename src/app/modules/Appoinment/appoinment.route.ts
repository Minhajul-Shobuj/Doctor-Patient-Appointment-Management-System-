...
router.get('/patient/appointments', auth('user'), AppointmentController.getAppointmentsByUser);
router.get('/doctor/appointments', auth('doctor'), AppointmentController.getAppointmentsByDoctor);
